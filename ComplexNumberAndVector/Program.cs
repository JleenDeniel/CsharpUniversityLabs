...
namespace ComplexNumber {
    ...
    public static class UnitTests {
        ...
        public static void VectorSum() {
            ...
            var doubleVector_1 = new System.Numerics.Vector<double>(doubleArr_1);
            var doubleVector_2 = new System.Numerics.Vector<double>(doubleArr_2);
            var doubleVector_3 = new System.Numerics.Vector<double>(doubleArr_3);

            var complexVector1 = new System.Numerics.Vector<Complex>(complexArr1);
            var complexVector2 = new System.Numerics.Vector<Complex>(complexArr2);
        ...
        public static void VectorOrthogonolization() {
            ...
            var doubleVector_2 = new System.Numerics.Vector<double>(doubleArr_2);
            var doubleVector_3 = new System.Numerics.Vector<double>(doubleArr_3);
            var doubleVectorArr = new System.Numerics.Vector<double>[3] { doubleVector_1, doubleVector_2, doubleVector_3 };

            var doubleArr_11 = new double[3] { 1, 0, 0};
            var doubleArr_22 = new double[3] { 0, 1, 0 };
            var doubleArr_33 = new double[3] { 0, 0, 1 };
            var doubleVector_11 = new System.Numerics.Vector<double>(doubleArr_11);
            var doubleVector_22 = new System.Numerics.Vector<double>(doubleArr_22);
            var doubleVector_33 = new System.Numerics.Vector<double>(doubleArr_33);
            var doubleVectorArr2 = new System.Numerics.Vector<double>[3] { doubleVector_11, doubleVector_22, doubleVector_33 };
            ...
            Console.WriteLine(Environment.NewLine);
            Console.WriteLine($"Ортогонолизация системы");
            System.Numerics.Vector<double>[] arr2 = System.Numerics.Vector<double>.Orthogonolization(doubleVectorArr2);
